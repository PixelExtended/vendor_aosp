...
custom_local_manifest = ".repo/local_manifests/pex.xml"
custom_default_revision = os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'thunder')
custom_fallback_revision = 'thunder'
